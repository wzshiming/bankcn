...
func RouteBankcnService(router *mux.Router, _bankcnService *githubComWzshimingBankcnServiceBankcn.BankcnService, fs ...mux.MiddlewareFunc) *mux.Router {
	...
	// Registered routing GET /bankcn
	var __operationGetBankcn http.Handler
	__operationGetBankcn = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		_operationGetBankcn(_bankcnService, w, r)
	})
	subrouter.Methods("GET").Path("").Handler(__operationGetBankcn)

	// Registered routing GET /bankcn/{bank}.jpg
	var __operationGetBankcnBankJpg http.Handler
	__operationGetBankcnBankJpg = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		_operationGetBankcnBankJpg(_bankcnService, w, r)
	})
	subrouter.Methods("GET").Path("/{bank}.jpg").Handler(__operationGetBankcnBankJpg)
...
// _operationGetBankcnBankJpg Is the route of BanksJPG
func _operationGetBankcnBankJpg(s *githubComWzshimingBankcnServiceBankcn.BankcnService, w http.ResponseWriter, r *http.Request) {
...
// _operationGetBankcn Is the route of Banks
func _operationGetBankcn(s *githubComWzshimingBankcnServiceBankcn.BankcnService, w http.ResponseWriter, r *http.Request) {
...
paths:
  /bankcn:
    get:
      tags:
      - BankcnService
      summary: 'Banks #route:"GET /"# 获取全部的银行'
      description: 'Banks #route:"GET /"# 获取全部的银行'
      responses:
        "200":
  ...
  /bankcn/{bank}.jpg:
    get:
      tags:
      - BankcnService
      summary: 'Banks #route:"GET /{bank}.jpg"# 获取某银行图标'
      description: 'Banks #route:"GET /{bank}.jpg"# 获取某银行图标'
      parameters:
